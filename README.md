...
Also, while publishing this application on the App store, I made a not bad ASO (app store optimization) without realizing it, and when you type Simple (basit) in the search field, the name of my application automatically appears in the search field (Basit Not Defteri). This helped the app to get some downloads :D
